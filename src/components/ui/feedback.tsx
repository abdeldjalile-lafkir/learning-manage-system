...
const Inline = ({
  ...
  return (
    <div
      className={clsx(
        "bg-background-100 my-6 shadow-border-small duration-200 overflow-hidden w-fit flex flex-col justify-start",
        ...
        <form className="w-full transition-opacity duration-300 opacity-100">
          <div className="flex flex-col gap-2 p-2 w-full">
            <Textarea
              ...
              ref={textAreaRef}
            />
            <div className="flex items-center justify-start gap-1 text-xs text-gray-900 ml-auto">
              <MSupportedIcon /> {supported || "supported."}
            </div>
          </div>
          <div className="flex  p-3  bg-accents-1 border-t border-accents-2">
