...
import { NotificationInboxPopover } from "@/components/dashboard/blocks/notification-inbox-popover";
...
export function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 w-full border-b md:border-0">
      <header
        className={cn(
      ...
      >
        <nav className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between px-4">
          <div className="hover:bg-accent flex cursor-pointer items-center gap-2 rounded-md px-2 py-1 duration-100">
            <p className="font-mono text-lg font-bold">{t("dashboard")}</p>
          </div>
