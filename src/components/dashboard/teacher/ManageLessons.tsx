  ...
  const demoEvents: Event[] = [
    {
      ...
      title: "Team Standup",
      description:
        "Daily sync with the engineering team to discuss progress and blockers",
    ...
    },
    {
      ...
      description:
        "Review new mockups for the dashboard redesign with stakeholders",
    ...
    },
    {
      ...
      description:
        "Plan tasks and estimate story points for the upcoming sprint",
