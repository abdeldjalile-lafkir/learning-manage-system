...
import { DonutChart as DC } from "@/components/ui/donut-chart";
...
export default function DonutChart() {
  ...
  return (
    <Card className="p-6 md:p-8 w-full mx-auto flex flex-col items-center justify-center space-y-6 bg-background text-foreground shadow-lg rounded-xl">
