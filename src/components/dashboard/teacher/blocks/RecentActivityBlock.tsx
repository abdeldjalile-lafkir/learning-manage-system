...
export default function CommunitySupportBlock() {
  ...
  return (
    <Card className="w-full max-w-1xl">
      <CardContent className="p-0 md:p-6 flex flex-col gap-8">
        {/* Ask the Community CTA */}
        <Card className="bg-primary/5 border border-primary/20 rounded-lg mb-2 md:p-4 p-2">
          ...
          <div className="flex flex-wrap gap-3">
            {FORUMS.map((forum) => (
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-muted-foreground/10 bg-background hover:bg-accent transition min-w-45"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-accent rounded-lg md:p-4 p-2">
            <CardContent className="flex flex-col gap-2 p-0">
              ...
              <div className="flex flex-col gap-2">
                {TRENDING_TOPICS.map((topic) => (
                  <Link
                    key={topic.title}
                    href={topic.url}
                    className="flex items-center justify-between gap-2 px-2 py-1 rounded-lg hover:bg-primary/10 transition text-sm"
                  >
